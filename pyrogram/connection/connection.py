...
from pyrogram.errors import InvalidChecksumError, InvalidBufferError
from pyrogram.session.internals import DataCenter
from pyrogram.utils import get_running_loop, _cancel
...
class Connection(abc.ABC):
    ...
    def __init__(
        ...
        self._ip = self.address[0]
        self._port = self.address[1]
        ...
        if python_socks:
            ...
            if local_addr is None:
                ...
                await asyncio.wait_for(
                    get_running_loop().sock_connect(sock=sock, address=address),
                    timeout=timeout
                )
